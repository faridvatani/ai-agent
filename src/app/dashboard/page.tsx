  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 min-h-full">
      <div className="relative max-w-2xl w-full">
        {/* Decorative elements */}
        <div className="absolute inset-0 -z-10 bg-linear-to-r from-gray-100 to-gray-50/50 rounded-3xl"></div>
        ...
        <div className="relative space-y-6 p-8 text-center">
          <div className="bg-white/60 backdrop-blur-xs shadow-xs ring-1 ring-gray-200/50 rounded-2xl p-6 space-y-4">
            <div className="bg-linear-to-b from-gray-50 to-white rounded-xl p-4 inline-flex">
              <BotIcon className="size-12 text-gray-600" />
            </div>
            <h2 className="text-2xl font-semibold bg-linear-to-br from-gray-900 to-gray-600 bg-clip-text text-transparent">
